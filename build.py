...
QUESTIONS = [
  ...
  dict(id="soft", zh="柔", py="róu", gloss="soft", title="Why does the soft win?",
       lede="Water is about the softest thing there is, and yet it wears away stone. What could a ruler, or any of us, learn from that?",
       passages=[
